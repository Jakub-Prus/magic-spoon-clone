...
const ShopCereal = () => {
  ...
  const shopData = [
    ...
    },
    {
      ...
      title: "FROSTED",
      description:
        "Sweet, subtle and smooth with hints of vanilla and marshmallow. We`ve reimagined your favorite simple cereal with only 4g net carbs, 13g complete protein, 140 calories, and nothing artificial.",
      reviews: "1097",
      color: "#f7ef79",
    },
    {
