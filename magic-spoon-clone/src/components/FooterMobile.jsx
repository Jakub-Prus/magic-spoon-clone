...
const FooterMobile = () => {
  return (
    <div className="block sm:hidden">
      ...
      >
        <p className="center-center pt-12 text-base font-light">Don`t miss the magic:</p>
      ...
      <div className="flex flex-col items-center justify-start">
        ...
        <p className="relative w-4/5 text-center text-xs">
          Terms of Use • Privacy Policy • Accessibility Policy • FAQ • Become an Affiliate
          • Reviews • Jobs • Track Orders • Store Locator • Terms of Service • Refund
          policy • For Creators
        </p>
